...
<main class="main__longread longread__background">
  <section class="longread__section">
    ...
    <!-- <picture class="glitch__top">
           <source media="(max-width: 320px)" srcset="./assets/longread/phone/glitch_hoofd_phone.png, ./assets/longread/ipad/glitch_hoofd_phone@2x.png "/>
           <source media="(max-width: 750px)" srcset="./assets/longread/ipad/glitch_blocks_top_ipad.png, ./assets/longread/ipad/glitch_blocks_top_ipad@2x.png "/>
      </picture> -->
