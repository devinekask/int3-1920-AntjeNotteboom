...
<article class="home__longread--article">
  <div class="home__longread--text">
     ...
     <h2 class="longread__text--title">If the lies don’t kill you, <br> the truth will</h2>
     <p class="longread__text--text">Do you want to know the truth?</p>
     <div class="longread__buttons">
     <a class="longread__button" href="index.php?page=longreadError"> Yes </a>
