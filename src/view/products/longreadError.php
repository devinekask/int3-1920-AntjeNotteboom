...
<!-- <img class="home__longread--image" src="./assets/longread/background_error.jpg" alt="glitch" width="100%" height="1024"> -->
  <section class=" error__longread--section">
    ...
    <article class="error__text">
      <h3 class="error__text--title">Error 404, pagina niet gevonden</h3>
      <p class="error__text--text">De pagina waar je naar op zoek was bestaat helaas niet (meer) of is wellicht verplaatst.
        Ga terug naar de <a class="error__link" href="index.php?page=longreadHome">home pagina</a>.</p>
    </article>
  </section>
</main>
